...
<!-- Nucleo Icons -->
<link
	href="<c:url value ='/template/admin/assets/css/nucleo-icons.css'/>"
	rel="stylesheet" />
<!-- CSS Files -->
<link
	href="<c:url value ='/template/admin/assets/css/black-dashboard.css?v=1.0.0'/>"
	rel="stylesheet" />
<!-- CSS Just for demo purpose, don't include it in your project -->
<link href="<c:url value ='/template/admin/assets/demo/demo.css'/>"
	rel="stylesheet" />
</head>
...
<body class="">
	...
	<!--   Core JS Files   -->
	<script
		src="<c:url value ='/template/admin/assets/js/core/jquery.min.js'/>"></script>
	<script
		src="<c:url value ='/template/admin/assets/js/core/popper.min.js'/>"></script>
	<script
		src="<c:url value ='/template/admin/assets/js/core/bootstrap.min.js'/>"></script>
	<script
		src="<c:url value ='/template/admin/assets/js/plugins/perfect-scrollbar.jquery.min.js'/>"></script>
	<!--  Google Maps Plugin    -->
	<!-- Place this tag in your head or just before your close body tag. -->
	<script src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script>
	<!-- Chart JS -->
	<script
		src="<c:url value ='/template/admin/assets/js/plugins/chartjs.min.js'/>"></script>
	<!--  Notifications Plugin    -->
	<script
		src="<c:url value ='/template/admin/assets/js/plugins/bootstrap-notify.js'/>"></script>
